  ...
  detail.innerHTML = `
    <div class="l1-page">
      ...
      <section class="l1-section l1-lower">
        ...
        <article class="l1-card"><span class="l1-eyebrow">My notebook</span><h3>The evidence of learning</h3><div class="l1-notebook-evidence" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem"><figure style="margin:0"><a href="assets/lesson-one-notebook-1.jpg" target="_blank" rel="noopener"><img src="assets/lesson-one-notebook-1.jpg" alt="Alan’s handwritten Lesson I notes, page one" style="display:block;width:100%;height:auto;border-radius:12px"></a><figcaption style="margin-top:.5rem">Lesson I notebook evidence · page 1</figcaption></figure><figure style="margin:0"><a href="assets/lesson-one-notebook-2.jpg" target="_blank" rel="noopener"><img src="assets/lesson-one-notebook-2.jpg" alt="Alan’s handwritten Lesson I vocabulary notes, page two" style="display:block;width:100%;height:auto;border-radius:12px"></a><figcaption style="margin-top:.5rem">Lesson I notebook evidence · page 2</figcaption></figure></div><p style="margin-top:1rem">Real notes, including uncertainty, corrections and repetition. Nothing has been polished away.</p></article>
      </section>
